...
def dataset_args():
    ...
    parser.add_argument('--dim_data', type=int, default=784)
...
def model_args():
    ...
    parser.add_argument('--dim_hidden_encoder', type=int, default=1024)
    parser.add_argument('--dim_hidden_decoder', type=int, default=1024)
